...
search_terms = ["Software Engineer", "Backend Developer", "Java Developer", "Python Developer", "Full Stack Developer", "Associate Software Engineer", "SDE 1", "Cyber Security Analyst", "SOC Analyst", "Embedded Software Engineer", "Embedded Systems Engineer", "Firmware Engineer", "Embedded Developer", "IoT Engineer"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Pune, Maharashtra, India"    # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", "PHP", "Ruby", "Sales", "Marketing", "HR", "Volunteer", "Unpaid", "Contract", "Temporary"]  # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
