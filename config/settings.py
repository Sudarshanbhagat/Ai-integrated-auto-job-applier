...
'''
Phase 2 intelligently selects resumes based on job requirements:
- Extracts job skills from description
- Maps to best matching resume type (backend/frontend/fullstack/etc)
- Rotates visual variants to avoid bot detection
- Expected improvement: +25-35% recruiter response rate
Requires: config/resume_config.py configured with your resumes
'''
