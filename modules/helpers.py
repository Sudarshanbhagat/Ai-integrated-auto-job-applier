"""
helpers module for shared utilities used across the project.

Note: I removed the original multi-line contributor header so
project provenance is maintained in git history and README.
"""
