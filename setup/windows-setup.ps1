"""
Windows setup helper for bootstrapping local environment.

Header removed — the repository's git history contains full
attribution. This script remains unchanged otherwise.
"""
